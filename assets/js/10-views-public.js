...
(function () {
  ...
  var GUIA_ROLES = [
    ...
    },
    {
      ...
      pasos: [
        ['Completar tu perfil', 'Registra tus habilidades como Básico, Intermedio o Avanzado. Los dos niveles altos piden respaldo: un certificado o un trabajo tuyo. De eso depende qué retos te recomendamos y a cuáles puedes postular.'],
    ...
    return h`<div style="max-width:900px;margin:0 auto">
      ...
      <div class="stack">
        ${[
          ...
          { q: '¿Cómo se elige a los estudiantes?', a: 'Por un puntaje de 0 a 100 que pesa habilidades, nivel declarado, cuánto respaldo tiene ese nivel, disponibilidad, afinidad con la carrera, ciclo y desempeño previo. El puntaje siempre se muestra desglosado: nadie queda seleccionado sin que se vea por qué.' },
          { q: '¿Cómo saben que el estudiante dice la verdad sobre su nivel?', a: 'No se confía en la declaración sola. El nivel se define por la evidencia que lo sostiene: Básico se autodeclara, pero Intermedio y Avanzado piden un certificado (la app reconoce los más comunes y propone el nivel que acreditan) o un trabajo propio que se pueda mostrar. Cada cambio de nivel queda registrado con su fecha, así que si alguien sube un nivel justo después de publicarse un reto, la coordinación lo ve al comparar candidatos. Y si declara Intermedio o Avanzado sin ningún respaldo en una habilidad indispensable, el sistema le pide una prueba práctica corta que revisa un docente.' },
          { q: '¿Y si alguien no tiene certificados?', a: 'No queda fuera. Puede respaldar su nivel con un trabajo propio —un tablero, un diseño, un repositorio, una cuenta que gestionó—, que es lo que más pesa en una postulación real, o con la prueba práctica. Exigir certificados dejaría fuera a quien no puede pagarlos, y muchos estudiantes aprenden trabajando.' },
          { q: '¿La app verifica los certificados automáticamente?', a: 'No, y conviene decirlo con claridad: la app reconoce el certificado, propone el nivel que acredita según el catálogo de equivalencias de la UPN y lo adjunta. Quien confirma es una persona. Una verificación automática real exigiría leer el documento y consultar al emisor.' },
          { q: '¿La prueba práctica es un examen?', a: 'No es un cuestionario de opción múltiple: eso se resuelve con el celular al lado y mide memoria, no capacidad. Es un encargo corto y concreto de 30 a 45 minutos, del tipo de trabajo que haría en el proyecto, y lo revisa un docente del área. Solo se pide cuando falta todo respaldo y la habilidad es indispensable para ese reto.' },
